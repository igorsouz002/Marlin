...
#define STRING_CONFIG_H_AUTHOR "(igorsouz002, Ender-3_SKR1.3)" // Who made the changes.
...
#define X_BED_SIZE 230    // Igor: E3D V6 Clone hotend installed
#define Y_BED_SIZE 225    // Igor: Caution with paper clips holding the bed.

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS -14     // Igor: E3D V6 Clone hotend installed, homing occurs outside the bed.
#define Z_MIN_POS 0
